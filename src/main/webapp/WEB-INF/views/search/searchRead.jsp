...
<script>
	var onlysearch = [];
	$(function(){
		$("#detail").on('click', detail_search);
		$('.gosearch').on('click', search);
	});
	
	function detail_search() {
		window.open('${onlysearch.link}');
	}
	function search(){
        ...
        <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										...
										<td>${onlysearch.searchedTitle}</td>
									</tr>
									<tr>
										<th style="width: 200px;">検索語</th>
										<td>${onlysearch.searchTitle}</td>
									</tr>
									<tr>
										<th>著者</th>
										<td>${onlysearch.author}</td>
									</tr>
									<tr>
										<th>発行日</th>
										<td>${onlysearch.publishedDate}</td>
									</tr>
									<tr>
									<tr>
										<th>抄錄</th>
										<td colspan="2" style="text-align: left;">${onlysearch.searchedAbstract}</td>
									</tr>
									<tr>
										<th style="width: 200px;">詳細表示</th>
										<td style="color: blue; cursor: pointer;" id="detail" class="detail" data-val="${onlysearch.link}">${onlysearch.link}</td>
									</tr>
									<tr style="text-align: right;">
											<td colspan="2">
												<a class="back btn btn-danger" href="javascript:history.back();" role="button" style="background-color: #e74a3b">
