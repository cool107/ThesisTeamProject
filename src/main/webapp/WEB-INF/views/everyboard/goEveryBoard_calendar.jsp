...
<li class="nav-item dropdown no-arrow mx-1">
						...
						<li class="nav-item dropdown no-arrow mx-1"><a href="/"
							style="font-size: 25px; color: white;"><ia class="fas fa-home"
								style="color: gray;"></ia></a></li>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="card shadow mb-4">
								<div class="card-header py-3" id ="update_tableee">
								
									<h3 class="m-0 font-weight-bold" style="color:#36b9cc;">
						...
						<div class="col-sm-6">
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h3 class="m-0 font-weight-bold" style="color:#36b9cc;">タスク</h3>
								</div>
								<div class="card-body">
									<div class="text-center">
										<a href="#" id="izen"
											class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
											<i class="fas fa-pencil-alt"></i> 今月のテスク</a> <a href="#"
											id="izen2"
											class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i
											class="fas fa-school"></i> 全体テスク</a> 
							...
							<div class="card shadow mb-4" id="update_Calendar">
								<div class="card-header py-3">
								<h3 class="m-0 font-weight-bold" style="color:#36b9cc;">テスクイ修正</h3>
									</div>
									<div class="card-body">
										<div class="text-center">
							...
							<div class="card shadow mb-4" id="insertCalendar">
								<div class="card-header py-3">
									<h3 class="m-0 font-weight-bold" style="color:#36b9cc;">テスクインサート</h3>
								</div>
								<div class="card-body">
									<div class="text-center">
										<div>
												...
												<table style="width: 100%;">
													...
													<tr>
														<td style="width: 100px;"><input type="hidden"
															...
															type="hidden" class="calendar_num" id="calendar_num">
															タイトル</td>
				...
				.on(
						...
						function() {
							...
							var id = $('#id').val(), department = $(
									'#department').val(), calendar_num = $(
									'#calendar_num').val(), schdule_title = $(
	...
	function output(resp) {
		...
		$.each(resp,function(index, item) {
							...
							data += '<td  style="padding:8px; width :100%;">'
									+ item.schdule_title + '<c:if test="${sessionScope.loginId == 'admin' }">'
									+ '<k class="far fa-edit" data-sno="'+item.calendar_num+'">'
									+ '</k>'
									+'<delete_ class="fas fa-trash-alt" data-sno="'+item.calendar_num+'"></delete_ >'		
									+'</c:if>'+'<br>';
// 									+ '<span>&nbsp;&nbsp;</span>';
							data += '<span></span>'+ item.start_day + '~'
									+ item.last_day + '<br>' + '場所:'
									+ item.place + '<br>' + 'メモ:'
									+ item.discription + '</td>';
							data += '</tr>';
	...
	function update_schedule_table() {
		...
		var calendar_num  = $(this).attr('data-sno');
		

		$.ajax({
			method : 'post',
			url : 'select_Every_calendar_update',
			data : {
				'calendar_num':calendar_num
			},success : function(resp){
				...
				+'<input type="hidden" class="department" id="department"><input type="hidden"  class="calendar_num" id="calendar_num">'
				...
				data +='<tr style="height: 5px;"></tr><tr style="text-align: right;"><td colspan="2"><button type="button" class="btn btn-outline-info" style="font-weight: bold;" sno="'+resp.calendar_num+'" id="calendar_update_submit">タスク保存</button></td></tr>';
				data += '</table>';
	...
	function update_schedule_submit() {
		...
		var calendar_num = $(this).attr('sno'), 
