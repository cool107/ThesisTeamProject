...
<script>
		...
		window.onload = function() {
		 CKEDITOR.replace('everyBoardContent', editorConfig);
		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<div class="container-fluid">
					...
					<hr class="sidebar-divider d-none d-md-block">
					<form id="insertEveryBoard" method="POST" action="insertEveryBoard" enctype="multipart/form-data">
						<div class="container-fluid">

							<div class="card shadow mb-4">
								<div class="card-body">
									<input type="text" style="width: 100%; line-height: 40px;"
										name="everyBoardTitle" id="everyBoardTitle"> <br>
									<br>
									...
									<div class="filebox">
										<input class="upload-name" value="ファイル選択" disabled="disabled"
											style="vertical-align: top; color: gray;"> <label
											for="ex_filename">ファイル添付</label> <input type="file"
											style="width: 100%;" name="upload" id="ex_filename" name="everyBoardOrgname"
											class="upload-hidden">
									</div>
								</div>
							</div>
